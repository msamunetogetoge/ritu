...
import { getFeed, toggleLike, addComment, getComments, type Post, type Comment } from "../services/community-service.ts";
        ...
        <article className="post-card">
            ...
            <div className="post-actions">
                ...
                <button type="button" onClick={loadComments}>
                   ...
                   {/* Count might be desynced without refetch, simpler to just show comment icon */}
                </button>
            </div>
            {showComments && (
                <div className="comments-section">
                    ...
                    <form onSubmit={submitComment}>
                        <input value={newComment} onChange={e => setNewComment(e.target.value)} placeholder="コメント..." />
